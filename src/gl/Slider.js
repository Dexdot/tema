...
export default class Slider {
  ...
  Init() {
    ...
    for (let i = 0; i < 7; i++) {
      ...
      this.arrB[
        i
      ].material.uniforms.dispersion.value = this.settings.dispersion;
      this.arrB[
        i
...
just drop me a message.`;
    ...
    const aboutText = isMobWidth ? mobileText : desktopText;

    let geometry = new THREE.TextBufferGeometry(aboutText, {
      font: spectralFont,
    ...
    this.menuTime = { about: 0, contact: 0 };
